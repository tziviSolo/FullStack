...
class SDK {
     ...
     */
    retrieveOwnerNotificationSettings(metadata) {
     ...
     */
    patchOwnerNotificationSettings(body, metadata) {
     ...
     */
    listNotificationOverrides(metadata) {
     ...
     */
    retrieveServiceNotificationOverrides(metadata) {
     ...
     */
    patchServiceNotificationOverrides(body, metadata) {
     ...
     */
    listRegistryCredentials(metadata) {
     ...
     */
    retrieveRegistryCredential(metadata) {
     ...
     */
    updateRegistryCredential(body, metadata) {
     ...
     */
    deleteRegistryCredential(metadata) {
     ...
     */
    updateEnvVarsForService(body, metadata) {
     ...
     */
    listSecretFilesForService(metadata) {
     ...
     */
    updateSecretFilesForService(body, metadata) {
     ...
     */
    addOrUpdateSecretFile(body, metadata) {
     ...
     */
    createCustomDomain(body, metadata) {
     ...
     */
    autoscaleService(body, metadata) {
     ...
     */
    deleteAutoscalingConfig(metadata) {
     ...
     */
    updateOwnerLogStream(body, metadata) {
     ...
     */
    listResourceLogStreams(metadata) {
     ...
     */
    updateResourceLogStream(body, metadata) {
     ...
     */
    deleteResourceLogStream(metadata) {
     ...
     */
    listApplicationFilterValues(metadata) {
     ...
     */
    retrieveRedisConnectionInfo(metadata) {
     ...
     */
    retrievePostgresConnectionInfo(metadata) {
     ...
     */
    retrievePostgresRecoveryInfo(metadata) {
     ...
     */
    updateEnvironment(body, metadata) {
     ...
     */
    addResourcesToEnvironment(body, metadata) {
     ...
     */
    removeResourcesFromEnvironment(metadata) {
     ...
     */
    linkServiceToEnvGroup(metadata) {
     ...
     */
    unlinkServiceFromEnvGroup(metadata) {
     ...
     */
    retrieveEnvGroupEnvVar(metadata) {
     ...
     */
    updateEnvGroupEnvVar(body, metadata) {
     ...
     */
    retrieveEnvGroupSecretFile(metadata) {
     ...
     */
    updateEnvGroupSecretFile(body, metadata) {
     ...
     */
    deleteEnvGroupSecretFile(metadata) {
     ...
     */
    updateMaintenance(body, metadata) {
